  ...
  <section class="section">
    <div class="container">
      ...
      <div class="grid grid-3">
        <div class="stat reveal"><div class="num">1</div><div class="label">Ano de história</div></div>
        <div class="stat reveal"><div class="num">5</div><div class="label">Ministérios ativos</div></div>
        <div class="stat reveal"><div class="num">1</div><div class="label">Culto por semana</div></div>
      </div>
    </div>
  </section>
